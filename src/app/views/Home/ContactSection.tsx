...
export function ContactSection({ isActive }: { isActive: boolean }) {
  return (
    <>
      ...
      {/* --- MOBILE CONTACT (Based on IPhone163) --- */}
      <div className="flex md:hidden relative w-full h-full flex-col overflow-y-auto overflow-x-hidden pt-[110px] px-[20px] pb-[60px]">
        {/* Header */}
        <motion.div
          initial="hidden"
        ...
        >
          ...
          <p className="mb-0">문제 해결보다 속도를 택하는 디자��너?</p>
